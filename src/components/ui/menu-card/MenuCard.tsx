...
const MenuCard = ({
  ...
  return (
    <div
      className="bg-primary text-primary-foreground flex flex-col rounded-md overflow-hidden border-2 border-primary drop-shadow-xs shadow-xs drop-shadow-white shadow-white group"
